    ...
    <section className="py-20 container mx-auto px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <div className="text-neon-dim text-sm tracking-widest font-mono">
            OPTO_DYNAMICS_PROCESSOR
          </div>
        </div>
        ...
        <div className="relative group mb-10">
          ...
          <div className="relative bg-bg border border-neon-dim rounded-sm p-8 space-y-6">
            {/* Package Info */}
            <div>
              <h3 className="text-neon text-xs uppercase tracking-widest border-b border-neon-dim/30 pb-1 mb-4">
                Installer Package
              </h3>
              <div className="font-mono text-sm text-gray-300 space-y-2">
                <p>
                  &gt;{" "}
                  <span className="text-neon">Birma v1.0.14 Installer.pkg</span>
                </p>
                <p className="text-neon-dim text-xs">
                  Includes AU and VST3 plugin formats
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="font-mono text-sm text-gray-300 space-y-2">
                <li className="flex items-center gap-2">
                  <span className="text-neon">&#10003;</span> All Apple Silicon
                  Macs (M1–M5+)
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-neon">&#10003;</span> Intel Macs
                  (x86_64)
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-neon">&#10003;</span> macOS 10.13 High
                  Sierra or later
                </li>
              </ul>
            </div>
        ...
        <div className="mt-8 border border-neon-dim/30 rounded-sm p-6 bg-neon/5">
          <h3 className="text-neon text-xs uppercase tracking-widest mb-3 font-mono">
            Installation Note
          </h3>
          <p className="text-gray-300 text-sm leading-relaxed mb-3">
            This plugin is not yet notarized with Apple. macOS may show a
            security warning when you first open the installer. To allow it:
          </p>
          <ol className="text-gray-300 text-sm leading-relaxed space-y-2 font-mono list-decimal list-inside">
            <li>
              Open <span className="text-neon">System Settings</span> &rarr;{" "}
              <span className="text-neon">Privacy &amp; Security</span>
            </li>
            <li>Scroll down to the Security section</li>
            <li>
              Click <span className="text-neon">"Open Anyway"</span> next to the
              blocked installer message
            </li>
          </ol>
          <p className="text-neon-dim text-xs mt-3">
            You only need to do this once. After installation the plugin will
            work normally.
          </p>
        </div>
      </div>
